...
import { withSetStateAllowed, sym } from 'enzyme/build/Utils';
...
describe.skip('shallow', () => {
  ...
  describe('.find(selector)', () => {
    ...
    it('should work on non-single nodes', () => {
      const wrapper = shallow(<div className="a">
          <div className="b">
    ...
    it('should support complex and nested object property selectors', () => {
      ...
      expect(wrapper
        .find({
          more: [{ id: 1 }], 'data-test': 'ref', prop: true, onChange: testFunction,
        })).to.have.length(1);
    });
  ...
  describe('.text()', () => {
    ...
    it('should handle simple text nodes', () => {
      const wrapper = shallow(<div>some text</div>);
  ...
  describe('.props()', () => {
    it('should return the props object', () => {
      const fn = () => ({});
      const wrapper = shallow(<div id="fooId" className="bax" onClick={fn} >
          <div className="baz" />
          <div className="foo" />
        </div>);
    ...
    it('should be allowed to be used on an inner node', () => {
      const fn = () => ({});
      const wrapper = shallow(<div className="bax">
  ...
  describe('.parents([selector])', () => {
    ...
    it('should optionally allow a selector', () => {
      const wrapper = shallow(<div className="bax foo">
          <div className="foo">
            <div className="bar">
              <div className="baz" />
            </div>
  ...
  describe('.html()', () => {
    it('should return html of straight DOM elements', () => {
      const wrapper = shallow(<div className="test">
  ...
  describe('.containsMatchingElement(node)', () => {
    ...
    it('should match on a single node that looks like a rendered one', () => {
      ...
      expect(wrapper.containsMatchingElement(<div onClick={spy1} style={{ fontSize: 12, color: 'red' }}>Hello World</div>)).to.equal(true); // eslint-disable-line no-max-len
      expect(wrapper.containsMatchingElement(<div style={{ fontSize: 12, color: 'red' }}>Hello World</div>)).to.equal(true); // eslint-disable-line no-max-len
      expect(wrapper.containsMatchingElement(<div onClick={spy2} style={{ fontSize: 13, color: 'blue' }}>Goodbye World</div>)).to.equal(true); // eslint-disable-line no-max-len
    ...
    it('should not match on a single node that doesn\'t looks like a rendered one', () => {
      ...
      const div = <div onClick={spy2}>Au revoir le monde</div>;
      expect(wrapper.containsMatchingElement(div)).to.equal(false);
    });
  ...
  describe('.dive()', () => {
    class RendersDOM extends Component {
      render() {
        return <div><i /></div>;
      }
    }
    class RendersNull extends Component {
      render() {
        return null;
      }
    }
    class RendersMultiple extends Component {
      render() {
        return (
          <div>
            <RendersNull />
    ...
    class WrapsRendersDOM extends Component {
      render() {
        return <RendersDOM />;
      }
    }
    WrapsRendersDOM.contextTypes = { foo: PropTypes.string };
    class DoubleWrapsRendersDOM extends Component {
      render() {
        return <WrapsRendersDOM />;
      }
    }
    class ContextWrapsRendersDOM extends Component {
      render() {
        return <WrapsRendersDOM />;
      }
    }
