...
import elementToTree from '../../src/elementToTree';
...
describe('RSTTraversal', () => {
  ...
  describe('nodeHasProperty', () => {
    ...
    it.skip('should not match on html attributes', () => {
  ...
  describe('treeForEach', () => {
    ...
    it.skip('should not get trapped from empty strings', () => {
      const spy = sinon.spy();
      const node = $(<div>
          <p>{''}</p>
        </div>);
  ...
  describe('pathToNode', () => {
    ...
    it.skip('should return trees from the root node', () => {
